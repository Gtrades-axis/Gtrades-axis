...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .manage-btn:hover { background: #3a66e0; }
        ...
        .modal-header p { color: #8ea2c0; font-size: 14px; }
        .detail-row {
            display: flex;
        ...
        .detail-row .label { color: #8ea2c0; font-weight: 500; }
        .modal-actions {
            display: flex;
            flex-wrap: wrap;
            gap: 10px;
        ...
        .btn-action:hover { background: #3a4a6a; }
        .btn-warning {
            background: #f5a623;
            color: #0b0d15;
        }
        ...
        .btn-danger:hover { background: #e63555; }
    </style>
</head>
<body>
    ...
    <script type="module">
        // ============================================================
        // COMPLETE MEMBERS MANAGEMENT (all logic in one file)
        // ============================================================
                ...
                snapshot.forEach((item) => {
                    ...
                    html += `
                        <tr>
                            ...
                            <td><button class="manage-btn" data-id="${item.id}">Manage</button></td>
                        </tr>
                    `;
                });
